...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            Matrix d1 = d2.multiply(w1.transpose()).removeBias().product(a1).product(of(a1.rows(), a1.cols(), 1.0).minus(a1));
        ...
        System.out.println();
        System.out.println(x.addBias().multiply(w0).sigmoid().addBias().multiply(w1).sigmoid());
    }
}